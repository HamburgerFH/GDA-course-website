...
- **Support:**  Beschreibt, ob ein item relevant ist:
...
- **Man kann weiter sehen:** 
  - der support einer Regel ist für alle Regeln über $X \cup Y$ gleich: Konfidenz sinnvoll
  - frequent itemset ($:=$ ein itemset, dass einen vorgegebenen support übersteigt):
  ist eine Obermenge ein frequent itemset, so müssen die Untermengen ebenfalls frequent sein
  $->$ Monotonie der Vereinigungsoperation
...
**_Hier nicht weiter betrachtet -> siehe Studienbrief 04, Kapitel 1.6 ff._**
